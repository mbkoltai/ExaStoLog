...
sel_params=par_inds_table(1:2,1); % all transition rates: unique(par_inds_table(:,1))'
% up or down rate?
sel_params_up_down=num2cell( par_inds_table(1:2,2)); % {[1 2],[1 2]}; all transition rates: arrayfun(@(x) par_inds_table(par_inds_table(:,1)==x,2)', scan_params,'un',0)
