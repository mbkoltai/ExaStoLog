...
plot_pars=[20 0.1 7 3 19]; % plot_pars=[fontsize,linewidth_val, arrowsize, default_markersize, highlight_markersize]
...
sel_params=3; sel_params_up_down={1};
...
figure('name','param fitting'); sel_nodes=find(sum(data_init_optim)>0 & sum(data_init_optim)<3); % 3:numel(nodes);
